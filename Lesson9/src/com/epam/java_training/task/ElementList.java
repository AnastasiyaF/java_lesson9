...
public class ElementList<E> {
	...
	private ElementList<E> next; //óêàçàòåëü íà ñëåäóþùèé ýëåìåíò
	private E element; //íåïîñðåäñòâåííî äàííûå
	
	ElementList(){// а куда пропали атрибуты доста у конструкторов?
